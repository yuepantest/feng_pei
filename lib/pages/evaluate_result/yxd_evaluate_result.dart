            ...
            Container(
              ...
              decoration: const BoxDecoration(
                  gradient: LinearGradient(colors: [
                    AppColors.yxdBackgroundStart,
                    AppColors.yxdBackgroundEnd
              ...
              child: Column(
                ...
                children: [
                  Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: duSetHeight(58)),
                        child: SizedBox(
                      ...
                      Padding(padding: EdgeInsets.only(top: duSetHeight(8),bottom: duSetHeight(20)),
                        child: Text("有效期："+setTimeData(data.applyTime)+"（可循环使用）", style: TextStyle(
                            color: AppColors.primaryBackground,
                            fontSize: duSetFontSize(12)),),)
              ...
              child: myButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => YXDEvaluateResultSecond(data: data),
                    ),
                  );
                },
